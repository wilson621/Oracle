...
// A full 45-minute recording at the desktop app's ~900kbps target caps out
// around ~304MB (see match-video-recording-coordinator.ts) -- this leaves
// meaningful headroom above that for encoder/container overhead while still
// rejecting anything wildly out of bounds outright.
