...
foreach ($requiredSource in @("GetWindowRect", "SetWindowPos", "RedrawWindow", "SetForegroundWindow", "PostMessage", "keyDown", "keyUp", "Thread", "-SampleInterval 1 -MaxSamples 2", "finally", "PrivatePageCount", "KernelModeTime", "UserModeTime", "CreationDate", "processExitRacePolls")) {
