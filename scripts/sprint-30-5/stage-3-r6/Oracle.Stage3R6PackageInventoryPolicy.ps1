...
function ConvertTo-OracleStage3R6CanonicalPackagePath {
...
function Test-OracleStage3R6ReservedPackageMetadata {
...
function Get-OracleStage3R6PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R6CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R6ReservedPackageMetadata $canonicalPath
