...
$first = @(Get-OracleStage3R6InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R6InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R6InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R6InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R6InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
