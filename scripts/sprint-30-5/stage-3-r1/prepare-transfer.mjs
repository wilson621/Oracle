...
if (argumentsMap.get("founder-authority") !== "FOUNDER-AUTHORISED-STAGE3-R1-TRANSFER") {
...
const sources = [
  ...
  join(import.meta.dirname, "Oracle.Stage3R1Contract.json"),
...
const manifestPath = join(transferRoot, "Oracle.Stage3R1TransferManifest.json");
...
console.log(JSON.stringify({ transferId, transferRoot, manifestHash }, null, 2));
