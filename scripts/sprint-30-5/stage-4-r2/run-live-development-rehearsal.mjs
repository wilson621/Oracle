...
try {
  ...
  console.log(JSON.stringify({ result: "passed", classification: journey.classification, authorityCreated: false, attemptCreated: false, qualificationEvidence: false, liveProviderExercised: true, installedPackageExercised: false, rehearsalSurface: "source-equivalent-r6-runtime-adapters", requiredJourneys: journey.journeys.length, operationalPhases: environment.phaseEvents.map(item => item.phase), zeroResidue: true }, null, 2));
