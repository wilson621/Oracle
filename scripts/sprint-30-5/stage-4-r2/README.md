# Stage 4 R2 engineering-preparation harness
...
- `node scripts/sprint-30-5/stage-4-r2/verify-preparation.mjs`
- `powershell.exe -NoProfile -ExecutionPolicy Bypass -File scripts/sprint-30-5/stage-4-r2/Invoke-OracleStage4R2DevelopmentRehearsal.ps1`
- elevated, non-qualification only: `Invoke-OracleStage4R2InstalledDevelopmentRehearsal.ps1 -ResultPath <fresh-path-under-rehearsal-root>`
- future pre-authority only: `Invoke-OracleStage4R2PreAuthorityPreflight.ps1 <bound-arguments>`
- future governed execution only: `Invoke-OracleStage4R2Qualification.ps1 <Founder-bound-arguments>`
