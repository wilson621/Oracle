...
. (Join-Path $PSScriptRoot "Oracle.Stage4R2InstalledRuntimeConfigurationPolicy.ps1")
...
$execution = "stage4-r2-20260803T120000000Z-a1b2c3d4"
...
try {
  ...
  $parameters = @{
    ...
    FounderGrantId = "founder-stage4-r2-grant-20260803T120000000Z-a1b2c3d4"
  ...
  $tamper = @{} + $parameters
  $tamper.AttemptId = "stage4-r2-20260803T120000000Z-a1b2c3d5"
  $tamper.ConfigurationId = "runtime-$($tamper.AttemptId)"
  $tamper.AuthorityId = "authority-$($tamper.AttemptId)"
  $tamper.FounderGrantId = "founder-stage4-r2-grant-20260803T120000000Z-a1b2c3d5"
  ...
  $partial = @{} + $parameters
  $partial.AttemptId = "stage4-r2-20260803T120000000Z-a1b2c3d6"
  $partial.ConfigurationId = "runtime-$($partial.AttemptId)"
  $partial.AuthorityId = "authority-$($partial.AttemptId)"
  $partial.FounderGrantId = "founder-stage4-r2-grant-20260803T120000000Z-a1b2c3d6"
  ...
  $firstSecret = New-OracleStage4R2CryptographicValue
  $secondSecret = New-OracleStage4R2CryptographicValue
  if (
  ...
  try {
    [void](New-OracleStage4R2CryptographicValue -EntropyProvider {
  ...
  [pscustomobject][ordered]@{
    contract = "oracle.sprint-30-5.stage-4-r2-installed-runtime-configuration-policy-test"
