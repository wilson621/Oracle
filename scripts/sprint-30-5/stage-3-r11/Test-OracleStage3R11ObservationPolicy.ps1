...
$captures = 0
$sleeps = 0
$result = Invoke-OracleStage3R11CompleteStableObservation `
...
if (
  ...
  throw "R11 stopped before captured evidence proved sixty complete seconds."
}
...
try {
  [void](Invoke-OracleStage3R11CompleteStableObservation `
...
$defaultClock = Invoke-OracleStage3R11CompleteStableObservation `
  -RequiredDurationSeconds 1 `
