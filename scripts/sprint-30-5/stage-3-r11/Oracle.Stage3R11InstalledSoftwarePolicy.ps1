...
function Get-OracleStage3R11OptionalPropertyValue {
  [CmdletBinding()]
  param(
...
function ConvertTo-OracleStage3R11InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  foreach ($entry in $RegistryEntries) {
    ...
    $displayNameValue = Get-OracleStage3R11OptionalPropertyValue `
    ...
    $displayVersionValue = Get-OracleStage3R11OptionalPropertyValue `
      -InputObject $entry -Name "DisplayVersion"
    $publisherValue = Get-OracleStage3R11OptionalPropertyValue `
...
function Get-OracleStage3R11InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  ConvertTo-OracleStage3R11InstalledSoftwareInventory -RegistryEntries $entries
}
