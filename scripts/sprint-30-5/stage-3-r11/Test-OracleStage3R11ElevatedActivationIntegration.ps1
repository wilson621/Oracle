...
$availability = Test-OracleStage3R11ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R11ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R11ApplicationActivationSucceeded -Result $activation
