...
$first = @(Get-OracleStage3R11InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R11InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R11InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R11InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R11InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
