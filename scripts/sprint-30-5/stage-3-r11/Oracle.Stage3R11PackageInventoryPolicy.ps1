...
function ConvertTo-OracleStage3R11CanonicalPackagePath {
...
function Test-OracleStage3R11ReservedPackageMetadata {
...
function Get-OracleStage3R11PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R11CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R11ReservedPackageMetadata $canonicalPath
