...
try {
  Assert-OracleStage3R11CertificateTrustContract -Contract $invalidContract
} catch {
...
$thumbprint = "8C24858C147873EF46A9D61018FA2702B6222EA2"
$subject = "CN=Oracle Stage 2 Requalification R6 Local Test Signing - NOT PRODUCTION"
$raw = [byte[]]@(1, 2, 3, 4)
...
$pathWithSpaces = "C:\Stage 3 R11\attempt certificate.cer"
$importArguments = @(Get-OracleStage3R11TrustImportArguments $pathWithSpaces)
if (
...
$removalArguments = @(Get-OracleStage3R11TrustRemovalArguments $thumbprint)
if (
