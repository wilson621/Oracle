...
function Get-OracleStage3R12OptionalPropertyValue {
  [CmdletBinding()]
  param(
...
function ConvertTo-OracleStage3R12InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  foreach ($entry in $RegistryEntries) {
    ...
    $displayNameValue = Get-OracleStage3R12OptionalPropertyValue `
    ...
    $displayVersionValue = Get-OracleStage3R12OptionalPropertyValue `
      -InputObject $entry -Name "DisplayVersion"
    $publisherValue = Get-OracleStage3R12OptionalPropertyValue `
...
function Get-OracleStage3R12InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  ConvertTo-OracleStage3R12InstalledSoftwareInventory -RegistryEntries $entries
}
