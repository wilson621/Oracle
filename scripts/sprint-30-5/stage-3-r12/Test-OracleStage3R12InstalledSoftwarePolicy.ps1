...
$first = @(Get-OracleStage3R12InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R12InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R12InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R12InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R12InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
