...
$execution = "stage3-r12-20260803T120000000Z-a1b2c3d4"
...
try {
  ...
  $tamper = @{} + $parameters
  $tamper.AttemptId = "stage3-r12-20260803T120000000Z-a1b2c3d5"
  $tamper.ConfigurationId = "runtime-$($tamper.AttemptId)"
  $tamper.AuthorityId = "authority-$($tamper.AttemptId)"
  $tamper.FounderGrantId = "founder-stage3-r12-grant-20260803T120000000Z-a1b2c3d5"
  ...
  $partial = @{} + $parameters
  $partial.AttemptId = "stage3-r12-20260803T120000000Z-a1b2c3d6"
  $partial.ConfigurationId = "runtime-$($partial.AttemptId)"
  $partial.AuthorityId = "authority-$($partial.AttemptId)"
  $partial.FounderGrantId = "founder-stage3-r12-grant-20260803T120000000Z-a1b2c3d6"
  ...
  $firstSecret = New-OracleStage3R12CryptographicValue
  $secondSecret = New-OracleStage3R12CryptographicValue
  if (
  ...
  try {
    [void](New-OracleStage3R12CryptographicValue -EntropyProvider {
  ...
  [pscustomobject][ordered]@{
    contract = "oracle.sprint-30-5.stage-3-r12-installed-runtime-configuration-policy-test"
