...
function ConvertTo-OracleStage3R12CanonicalPackagePath {
...
function Test-OracleStage3R12ReservedPackageMetadata {
...
function Get-OracleStage3R12PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R12CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R12ReservedPackageMetadata $canonicalPath
