...
try {
  Assert-OracleStage3R12CertificateTrustContract -Contract $invalidContract
} catch {
...
$pathWithSpaces = "C:\Stage 3 R12\attempt certificate.cer"
$importArguments = @(Get-OracleStage3R12TrustImportArguments $pathWithSpaces)
if (
...
$removalArguments = @(Get-OracleStage3R12TrustRemovalArguments $thumbprint)
if (
