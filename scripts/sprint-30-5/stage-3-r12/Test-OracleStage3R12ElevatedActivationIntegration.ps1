...
$availability = Test-OracleStage3R12ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R12ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R12ApplicationActivationSucceeded -Result $activation
