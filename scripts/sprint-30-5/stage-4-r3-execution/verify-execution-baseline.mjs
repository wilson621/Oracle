...
assert.equal(sha256(join(repositoryRoot, "scripts/sprint-30-5/stage-4-r3/Oracle.Stage4R3PreparationManifest.json")), contract.acceptedPreparation.preparationManifestSha256);
...
const executionManifest = JSON.parse(readFileSync(join(harnessRoot, "Oracle.Stage4R3ExecutionManifest.json"), "utf8"));
