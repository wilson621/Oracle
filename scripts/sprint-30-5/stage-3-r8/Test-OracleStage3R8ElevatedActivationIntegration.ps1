...
$availability = Test-OracleStage3R8ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R8ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R8ApplicationActivationSucceeded -Result $activation
