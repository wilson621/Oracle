...
$first = @(Get-OracleStage3R8InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R8InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R8InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R8InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R8InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
