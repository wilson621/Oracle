...
function ConvertTo-OracleStage3R8CanonicalPackagePath {
...
function Test-OracleStage3R8ReservedPackageMetadata {
...
function Get-OracleStage3R8PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R8CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R8ReservedPackageMetadata $canonicalPath
