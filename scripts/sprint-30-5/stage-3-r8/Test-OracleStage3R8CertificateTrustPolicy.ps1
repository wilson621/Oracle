...
try {
  Assert-OracleStage3R8CertificateTrustContract -Contract $invalidContract
} catch {
...
$thumbprint = "119937D4B90068ACE8765695C5A94321A2C40BD8"
$subject = "CN=Oracle Stage 2 Requalification R2 Local Test Signing - NOT PRODUCTION"
$raw = [byte[]]@(1, 2, 3, 4)
...
$pathWithSpaces = "C:\Stage 3 R8\attempt certificate.cer"
$importArguments = @(Get-OracleStage3R8TrustImportArguments $pathWithSpaces)
if (
...
$removalArguments = @(Get-OracleStage3R8TrustRemovalArguments $thumbprint)
if (
