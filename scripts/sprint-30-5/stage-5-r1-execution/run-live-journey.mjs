...
try {
  ...
  const apiResponse = await fetch(`${web}/api/oracle/conversation`, { method:"POST",headers:{cookie:cookieHeader,"content-type":"application/json"},body:JSON.stringify({requestId:`stage5-r1-${nonce}`,text:"qualification probe"}),redirect:"manual" });
