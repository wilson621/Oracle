...
assert.equal(manifest.transferId,contract.replacementMission.transferId);
assert.equal(manifest.founderGrantId,contract.replacementMission.founderGrantId);
assert.equal(manifest.executionContractSha256,sha256(contractPath));
assert.equal(manifest.replacesTransferId,contract.replacementMission.replacesTransferId);
