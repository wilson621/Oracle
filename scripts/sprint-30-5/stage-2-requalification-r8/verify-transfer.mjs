...
const verification={schemaVersion:"1.0.0",contract:"oracle.sprint-30-5.stage-2-r8-transfer-verification",result:"passed",classification:"INDEPENDENT TRANSFER VERIFICATION",verifiedAtUtc:new Date().toISOString(),transferId:manifest.transferId,manifestSha256:sha256(manifestPath),custodySha256:sha256(custodyPath),executionCommit:manifest.executionCommit,executionTree:manifest.executionTree,files:actual.length,bytes:custody.bytes,authorityCreated:false,attemptCreated:false};
