...
if ([string]$sourceContract.executionMission.transferId -cne [string]$sourceAdmission.transferId -or [string]$sourceContract.executionMission.founderGrantId -cne $FounderGrantId) { throw 'R8 source contract mission binding differs.' }
