...
$execution = "stage3-r13-20260803T120000000Z-a1b2c3d4"
...
try {
  ...
  $packageFullName = "Oracle.Platform.LocalCertification_0.1.6.0_x64__fw69ec0wxwzn4"
  ...
  $tamper = @{} + $parameters
  $tamper.AttemptId = "stage3-r13-20260803T120000000Z-a1b2c3d5"
  $tamper.ConfigurationId = "runtime-$($tamper.AttemptId)"
  $tamper.AuthorityId = "authority-$($tamper.AttemptId)"
  $tamper.FounderGrantId = "founder-stage3-r13-grant-20260803T120000000Z-a1b2c3d5"
  ...
  $partial = @{} + $parameters
  $partial.AttemptId = "stage3-r13-20260803T120000000Z-a1b2c3d6"
  $partial.ConfigurationId = "runtime-$($partial.AttemptId)"
  $partial.AuthorityId = "authority-$($partial.AttemptId)"
  $partial.FounderGrantId = "founder-stage3-r13-grant-20260803T120000000Z-a1b2c3d6"
  ...
  $firstSecret = New-OracleStage3R13CryptographicValue
  $secondSecret = New-OracleStage3R13CryptographicValue
  if (
  ...
  try {
    [void](New-OracleStage3R13CryptographicValue -EntropyProvider {
  ...
  [pscustomobject][ordered]@{
    contract = "oracle.sprint-30-5.stage-3-r13-installed-runtime-configuration-policy-test"
