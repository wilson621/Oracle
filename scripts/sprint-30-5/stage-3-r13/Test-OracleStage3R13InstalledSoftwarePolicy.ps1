...
$first = @(Get-OracleStage3R13InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R13InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R13InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R13InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R13InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
