...
function Get-OracleStage3R13OptionalPropertyValue {
  [CmdletBinding()]
  param(
...
function ConvertTo-OracleStage3R13InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  foreach ($entry in $RegistryEntries) {
    ...
    $displayNameValue = Get-OracleStage3R13OptionalPropertyValue `
    ...
    $displayVersionValue = Get-OracleStage3R13OptionalPropertyValue `
      -InputObject $entry -Name "DisplayVersion"
    $publisherValue = Get-OracleStage3R13OptionalPropertyValue `
...
function Get-OracleStage3R13InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  ConvertTo-OracleStage3R13InstalledSoftwareInventory -RegistryEntries $entries
}
