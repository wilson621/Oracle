...
$captures = 0
$sleeps = 0
$result = Invoke-OracleStage3R13CompleteStableObservation `
...
if (
  ...
  throw "R13 stopped before captured evidence proved sixty complete seconds."
}
...
try {
  [void](Invoke-OracleStage3R13CompleteStableObservation `
...
$defaultClock = Invoke-OracleStage3R13CompleteStableObservation `
  -RequiredDurationSeconds 1 `
