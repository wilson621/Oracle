...
function ConvertTo-OracleStage3R10CanonicalPackagePath {
...
function Test-OracleStage3R10ReservedPackageMetadata {
...
function Get-OracleStage3R10PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R10CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R10ReservedPackageMetadata $canonicalPath
