...
try {
  Assert-OracleStage3R10CertificateTrustContract -Contract $invalidContract
} catch {
...
$thumbprint = "03BEFBF303751D3DC14DF3FA224EB6BC5A6E4222"
$subject = "CN=Oracle Stage 2 Requalification R4 Local Test Signing - NOT PRODUCTION"
$raw = [byte[]]@(1, 2, 3, 4)
...
$pathWithSpaces = "C:\Stage 3 R10\attempt certificate.cer"
$importArguments = @(Get-OracleStage3R10TrustImportArguments $pathWithSpaces)
if (
...
$removalArguments = @(Get-OracleStage3R10TrustRemovalArguments $thumbprint)
if (
