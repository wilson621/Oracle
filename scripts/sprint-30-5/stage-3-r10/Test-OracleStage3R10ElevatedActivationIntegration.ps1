...
$availability = Test-OracleStage3R10ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R10ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R10ApplicationActivationSucceeded -Result $activation
