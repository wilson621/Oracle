...
$first = @(Get-OracleStage3R10InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R10InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R10InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R10InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R10InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
