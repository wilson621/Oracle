...
function Get-OracleStage3R10OptionalPropertyValue {
  [CmdletBinding()]
  param(
...
function ConvertTo-OracleStage3R10InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  foreach ($entry in $RegistryEntries) {
    ...
    $displayNameValue = Get-OracleStage3R10OptionalPropertyValue `
    ...
    $displayVersionValue = Get-OracleStage3R10OptionalPropertyValue `
      -InputObject $entry -Name "DisplayVersion"
    $publisherValue = Get-OracleStage3R10OptionalPropertyValue `
...
function Get-OracleStage3R10InstalledSoftwareInventory {
  [CmdletBinding()]
  param(
  ...
  ConvertTo-OracleStage3R10InstalledSoftwareInventory -RegistryEntries $entries
}
