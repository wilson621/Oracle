...
$captures = 0
$sleeps = 0
$result = Invoke-OracleStage3R10CompleteStableObservation `
...
if (
  ...
  throw "R10 stopped before captured evidence proved sixty complete seconds."
}
...
try {
  [void](Invoke-OracleStage3R10CompleteStableObservation `
...
$defaultClock = Invoke-OracleStage3R10CompleteStableObservation `
  -RequiredDurationSeconds 1 `
