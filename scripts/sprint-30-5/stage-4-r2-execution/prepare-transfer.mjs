...
const identity = transferId.slice("transfer-stage4-r2-".length);
...
const executionManifestPath = path.join(harnessRoot, "Oracle.Stage4R2ExecutionManifest.json");
const manifest = {
  contract: "oracle.sprint-30-5.stage-4-r2-transfer-manifest",
  schemaVersion: "1.0.0",
  transferId,
...
const custody = {
  contract: "oracle.sprint-30-5.stage-4-r2-transfer-custody",
  schemaVersion: "1.0.0",
  transferId,
  createdAtUtc: timestampUtc,
  manifestSha256,
