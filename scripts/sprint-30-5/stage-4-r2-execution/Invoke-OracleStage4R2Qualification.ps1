...
. (Join-Path $PSScriptRoot 'Oracle.Stage4R2TransferPolicy.ps1')
...
$transferAdmission=Assert-OracleStage4R2Transfer -RepositoryRoot $root -Contract $contract -TransferRoot $TransferRoot -ExpectedManifestSha256 $TransferManifestSha256 -ExpectedCustodySha256 $TransferCustodySha256 -ExecutionCommit $PreparationCommit -ExecutionTree $PreparationTree
