...
export const contractPath = join(import.meta.dirname, "Oracle.Stage4R2Contract.json");
...
const attemptPattern = new RegExp(`^stage4-r2-${compactTime}-${suffix}$`, "u");
const authorityPattern = new RegExp(`^authority-stage4-r2-${compactTime}-${suffix}$`, "u");
