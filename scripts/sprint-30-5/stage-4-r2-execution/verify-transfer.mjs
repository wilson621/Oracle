...
const verification = { contract: "oracle.sprint-30-5.stage-4-r2-transfer-verification", schemaVersion: "1.0.0", result: "passed", classification: "INDEPENDENT-TRANSFER-VERIFICATION", verifiedAtUtc: new Date().toISOString(), transferId: manifest.transferId, manifestSha256: sha256(manifestPath), custodySha256: sha256(custodyPath), executionCommit: manifest.executionCommit, executionTree: manifest.executionTree, files: physical.length, bytes: custody.bytes, authorityCreated: false, attemptCreated: false };
