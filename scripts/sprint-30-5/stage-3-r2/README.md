# Sprint 30.5 Stage 3 Qualification R2 Harness

This directory contains the prepared, R2-bound Stage 3 R2 transfer and clean
...
The shared `Oracle.Stage3R2IdentityPolicy.ps1` implements ordinal
...
`Get-OracleStage3R2HostContinuity.ps1` creates the fresh, create-only,
...
`docs/sprints/SPRINT_30_5_STAGE_3_R2_PRE_EXECUTION_GATE.md`.
