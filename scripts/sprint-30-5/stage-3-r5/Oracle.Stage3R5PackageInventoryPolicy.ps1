...
function ConvertTo-OracleStage3R5CanonicalPackagePath {
...
function Test-OracleStage3R5ReservedPackageMetadata {
...
function Get-OracleStage3R5PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R5CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R5ReservedPackageMetadata $canonicalPath
