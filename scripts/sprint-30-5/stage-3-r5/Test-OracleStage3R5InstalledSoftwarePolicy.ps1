...
$first = @(Get-OracleStage3R5InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R5InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R5InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R5InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R5InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
