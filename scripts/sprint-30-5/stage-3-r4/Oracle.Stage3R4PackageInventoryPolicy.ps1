...
function ConvertTo-OracleStage3R4CanonicalPackagePath {
...
function Test-OracleStage3R4ReservedPackageMetadata {
...
function Get-OracleStage3R4PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R4CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R4ReservedPackageMetadata $canonicalPath
