...
assert.equal(manifest.contract, "oracle.sprint-30-5.stage-3-r9-archive-manifest");
assert.match(manifest.attemptId, /^stage3-r9-\d{8}T\d{9}Z-[0-9a-f]{8}$/u);
assert.equal(
...
assert.equal(
  ...
  "oracle.sprint-30-5.stage-3-r9-evidence-manifest"
);
