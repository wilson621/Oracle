...
$availability = Test-OracleStage3R9ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R9ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R9ApplicationActivationSucceeded -Result $activation
