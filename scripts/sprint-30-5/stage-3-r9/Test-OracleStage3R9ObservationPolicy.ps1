...
$captures = 0
$sleeps = 0
$result = Invoke-OracleStage3R9CompleteStableObservation `
...
if (
  ...
  throw "R9 stopped before captured evidence proved sixty complete seconds."
}
...
try {
  [void](Invoke-OracleStage3R9CompleteStableObservation `
...
$defaultClock = Invoke-OracleStage3R9CompleteStableObservation `
  -RequiredDurationSeconds 1 `
