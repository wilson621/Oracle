...
function ConvertTo-OracleStage3R9CanonicalPackagePath {
...
function Test-OracleStage3R9ReservedPackageMetadata {
...
function Get-OracleStage3R9PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R9CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R9ReservedPackageMetadata $canonicalPath
