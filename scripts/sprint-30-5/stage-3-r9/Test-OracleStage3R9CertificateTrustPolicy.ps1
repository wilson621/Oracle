...
try {
  Assert-OracleStage3R9CertificateTrustContract -Contract $invalidContract
} catch {
...
$pathWithSpaces = "C:\Stage 3 R9\attempt certificate.cer"
$importArguments = @(Get-OracleStage3R9TrustImportArguments $pathWithSpaces)
if (
...
$removalArguments = @(Get-OracleStage3R9TrustRemovalArguments $thumbprint)
if (
