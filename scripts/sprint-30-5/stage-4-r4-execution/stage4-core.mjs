...
export const contractPath = join(import.meta.dirname, "Oracle.Stage4R4Contract.json");
...
const attemptPattern = new RegExp(`^stage4-r4-${compactTime}-${suffix}$`, "u");
const authorityPattern = new RegExp(`^authority-stage4-r4-${compactTime}-${suffix}$`, "u");
...
export function validateAcceptedBindings() {
  ...
  assert.match(contract.executionAuthority.requiredFutureToken, /^[0-9a-f]{64}$/u);
  ...
  assert.equal(contract.acceptedPreparation.preparationManifestSha256, "6188b37a89c5d8fbc8a228a653cc4100cc774310271d54f779f26ea2e918f6df");
  assert.equal(contract.acceptedPreparation.engineeringClosureSha256, "fc5fb3b7b474b0cbb15b4068815558b9326a9640bfab61bc99791b2b210d59ac");
