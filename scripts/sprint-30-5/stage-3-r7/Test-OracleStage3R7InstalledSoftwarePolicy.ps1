...
$first = @(Get-OracleStage3R7InstalledSoftwareInventory -RegistryViewReader $reader)
$second = @(Get-OracleStage3R7InstalledSoftwareInventory -RegistryViewReader $reader)
...
try {
  $ignored = @(ConvertTo-OracleStage3R7InstalledSoftwareInventory -RegistryEntries @(
...
try {
  [void](ConvertTo-OracleStage3R7InstalledSoftwareInventory -RegistryEntries @($null))
} catch {
...
try {
  [void](Get-OracleStage3R7InstalledSoftwareInventory -RegistryViewReader {
    param($Name, $Path)
