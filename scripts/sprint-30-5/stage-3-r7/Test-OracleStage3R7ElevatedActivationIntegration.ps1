...
$availability = Test-OracleStage3R7ApplicationActivationApi
if (-not $availability.available) {
  throw "IApplicationActivationManager is unavailable: $($availability.hresult)"
}
$activation = Invoke-OracleStage3R7ApplicationActivation `
  -AppUserModelId $AppUserModelId
Assert-OracleStage3R7ApplicationActivationSucceeded -Result $activation
