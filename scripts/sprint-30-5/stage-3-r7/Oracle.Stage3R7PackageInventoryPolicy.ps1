...
function ConvertTo-OracleStage3R7CanonicalPackagePath {
...
function Test-OracleStage3R7ReservedPackageMetadata {
...
function Get-OracleStage3R7PackageZipInventory {
  ...
  try {
    ...
    foreach ($entry in $archive.Entries) {
      ...
      $canonicalPath =
        ConvertTo-OracleStage3R7CanonicalPackagePath $rawPath
      ...
      $records.Add([pscustomobject][ordered]@{
        ...
        reservedContainerMetadata =
          Test-OracleStage3R7ReservedPackageMetadata $canonicalPath
