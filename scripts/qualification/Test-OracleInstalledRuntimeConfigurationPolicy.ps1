...
. (Join-Path $PSScriptRoot "Oracle.InstalledRuntimeConfigurationPolicy.ps1")
...
$execution = "stage5-r1-20260803T120000000Z-a1b2c3d4"
...
try {
  ...
  $tamper = @{} + $parameters
  $tamper.AttemptId = "stage5-r1-20260803T120000000Z-a1b2c3d5"
  $tamper.ConfigurationId = "runtime-$($tamper.AttemptId)"
  $tamper.AuthorityId = "authority-$($tamper.AttemptId)"
  $tamper.FounderGrantId = "founder-stage5-r1-grant-20260803T120000000Z-a1b2c3d5"
  ...
  $partial = @{} + $parameters
  $partial.AttemptId = "stage5-r1-20260803T120000000Z-a1b2c3d6"
  $partial.ConfigurationId = "runtime-$($partial.AttemptId)"
  $partial.AuthorityId = "authority-$($partial.AttemptId)"
  $partial.FounderGrantId = "founder-stage5-r1-grant-20260803T120000000Z-a1b2c3d6"
  ...
  [pscustomobject][ordered]@{
    contract = "oracle.installed-runtime-configuration-policy-test"
