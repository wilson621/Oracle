...
export function analyseTrends(sessions: TrendSession[]): TrendProfile {
  ...
  const confidenceChange = latestSession.confidence - firstSession.confidence;
...
function buildSkillTrends(
  ...
  return [
    buildSkillTrend("Positioning", firstSession.positioning, latestSession.positioning),
    buildSkillTrend("Aim", firstSession.aim, latestSession.aim),
    buildSkillTrend("Movement", firstSession.movement, latestSession.movement),
    buildSkillTrend(
      "Decision Making",
      firstSession.decisionMaking,
      latestSession.decisionMaking
    ),
    buildSkillTrend("Game Sense", firstSession.gameSense, latestSession.gameSense),
  ];
}
...
function getStrongestImprovement(skillTrends: SkillTrend[]): SkillTrend | null {
...
function getSharpestDecline(skillTrends: SkillTrend[]): SkillTrend | null {
