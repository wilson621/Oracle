...
| Sprint 30.5 Stage 2 Requalification R4 pre-execution gate | [Sprint 30.5 Stage 2 Requalification R4 Pre-Execution Gate](sprints/SPRINT_30_5_STAGE_2_REQUALIFICATION_R4_PRE_EXECUTION_GATE.md) | Exact pre-authority requirements; execution not authorised |
| Sprint 30.5 Stage 2 Requalification R4 preparation validation | [Sprint 30.5 Stage 2 Requalification R4 Preparation Validation](sprints/SPRINT_30_5_STAGE_2_REQUALIFICATION_R4_PREPARATION_VALIDATION_REPORT.md) | Non-qualification validation and review record |
