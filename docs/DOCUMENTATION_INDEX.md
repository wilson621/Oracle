...
| R5 pre-authority failure and replacement | [Sprint 30.5 Stage 4 R5 Pre-Authority Failure and Replacement](sprints/SPRINT_30_5_STAGE_4_R5_PRE_AUTHORITY_FAILURE_AND_REPLACEMENT.md) | Immutable failed transfer, recovered zero state, optional-version correction and replacement boundary |
| R5 private-link failure and correction | [Sprint 30.5 Stage 4 R5 Private-Link Failure and Correction](sprints/SPRINT_30_5_STAGE_4_R5_PRIVATE_LINK_FAILURE_AND_CORRECTION.md) | Second immutable pre-authority failure, zero-residue teardown and race-tolerant address reconciliation |
| R5 automatic-variable failure and correction | [Sprint 30.5 Stage 4 R5 Automatic-Variable Failure and Correction](sprints/SPRINT_30_5_STAGE_4_R5_AUTOMATIC_VARIABLE_FAILURE_AND_CORRECTION.md) | Third immutable pre-authority failure, protected-variable correction and AST/runtime regression |
