...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R3 preparation is active |
| 3 | Clean Windows Qualification | **R2 failed closed before governed mutation; R3 preparation active; execution blocked and unauthorised** | R1 and R2 remain immutable historical preparation. R2 identity `stage3-r2-20260730T124016125Z-d0037861` failed because function-scoped `MyCommand` has no `Path`; its authority is retired. R3 preserves the host-name policy and captures the executing harness path once at script scope under `powershell.exe -File`. `Founder-QA-01` continuity must be fresh at execution. | Founder approval of the exact R3 transfer and one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1 and failed R2 remain immutable historical preparation; Stage 3 Qualification R3 preparation is active while execution remains blocked and unauthorised; Stages 4–7 have not started |
