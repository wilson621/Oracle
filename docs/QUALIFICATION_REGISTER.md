...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R4 preparation is active |
| 3 | Clean Windows Qualification | **R2 and R3 failed closed; R4 preparation active; execution blocked and unauthorised** | R1–R3 remain immutable. R2 exposed the function-scoped self-path defect; R3 corrected it and then failed during inventory reconciliation because the immutable ZIP has `2,202` file entries while the governed logical payload has `2,201`. R4 validates all decoded payload entries and exact `[Content_Types].xml` metadata without changing the MSIX. `Founder-QA-01` continuity must be fresh at execution. | Founder approval of the exact R4 transfer and one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1, failed R2 and failed R3 remain immutable; Stage 3 Qualification R4 preparation is active while execution remains blocked and unauthorised; Stages 4–7 have not started |
