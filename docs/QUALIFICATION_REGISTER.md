...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R1 preparation is Founder-authorised |
| 3 | Clean Windows Qualification | **Stage 3 Qualification R1 preparation active; execution blocked and unauthorised** | The R2-bound R1 plan, contract, transfer builder and ordered clean-host harness replace the retired operational path without altering historical Stage 3 records. `Founder-QA-01` remains historically admitted with a Founder provenance exception, but continuity and transfer-method approval must be fresh at execution. | Complete preparation validation and stop for a separate Founder execution decision |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, R1 and R2 are closed; R1 remains immutable historical evidence; R2 is authoritative; Stage 3 Qualification R1 preparation is authorised while execution remains blocked and unauthorised; Stages 4–7 have not started |
