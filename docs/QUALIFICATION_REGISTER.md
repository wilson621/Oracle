...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R2 corrective preparation is complete |
| 3 | Clean Windows Qualification | **Stage 3 Qualification R2 corrective preparation complete; execution blocked and unauthorised** | R1 remains immutable historical preparation. The R2-bound plan, contract, transfer builder, shared ordinal-ignore-case Windows computer-name policy, continuity collector, ordered clean-host harness, return verifier and pre-execution gate passed non-execution validation. `Founder-QA-01` remains historically admitted with a Founder provenance exception, but continuity must be fresh at execution. | Founder approval of the exact R2 transfer and one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1 remains immutable historical preparation; Stage 3 Qualification R2 corrective preparation is complete while execution remains blocked and unauthorised; Stages 4–7 have not started |
