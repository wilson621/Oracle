...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R5 preparation is active |
| 3 | Clean Windows Qualification | **R2, R3 and R4 failed closed; R5 preparation active; execution blocked and unauthorised** | Stage 3 Qualification R2, Stage 3 Qualification R3 and Stage 3 Qualification R4 remain immutable. R4 proved exact `2,202` ZIP / `2,201` logical package reconciliation, then failed under consumed attempt `stage3-r4-20260730T142810425Z-34cd5760` because optional uninstall `DisplayName` was accessed directly under StrictMode. R5 preserves StrictMode, introduces a shared safe deterministic inventory policy, full optional-member/phase audits, development rehearsal and transfer-bound pre-authority host probe. `Founder-QA-01` continuity must be fresh at execution. | Founder approval of the exact R5 transfer, passed pre-authority probe and one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1 and failed R2, R3 and R4 remain immutable; Stage 3 Qualification R5 preparation is active while execution remains blocked and unauthorised; Stages 4–7 have not started |
