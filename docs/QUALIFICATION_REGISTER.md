...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R6 preparation is active |
| 3 | Clean Windows Qualification | **R2–R5 failed closed; R6 preparation active; transfer and execution blocked** | R1–R5 remain immutable. R5 Attempt 1 passed strict Authenticode validation under `CurrentUser\Root`, then AppX deployment failed with `0x800B0109` because user-scoped root trust was not the machine-scoped package trust required by the deployment provider. R6 preserves every prior control and implements exact elevated `LocalMachine\TrustedPeople` trust with physical/logical-store distinction and exact teardown. `Founder-QA-01` continuity and pre-authority elevation must be fresh at execution. | Founder approval of the validated R6 preparation, then one exact transfer and separately one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1 and failed R2–R5 remain immutable; Stage 3 Qualification R6 preparation is active while transfer and execution remain blocked and unauthorised; Stages 4–7 have not started |
