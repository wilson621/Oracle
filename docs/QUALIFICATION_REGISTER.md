...
| 2 | Candidate Freeze and Package Reconciliation | **Historical candidate and R1 accepted and immutable; R2 Founder-accepted and formally closed** | Accepted R2 attempt `r2-20260728T203503018Z-ec577cf4` binds authoritative candidate `11475fe01fff2ec69f0188547107f4e901c531d7`; final evidence manifest SHA-256 `84660931dec8c2c4f4e409465e67e49d9606f8617824e7c1212bb2e8abf1d47d` | None for Stage 2 R2; Stage 3 Qualification R8 engineering is active |
| 3 | Clean Windows Qualification | **R2-R7 failed closed; R8 engineering active; transfer and execution blocked** | R1-R7 remain immutable. R7 proved direct activation, package ownership and native window discovery, then exposed Windows PowerShell 5.1 top-level JSON-array handling and a filesystem-only process-ownership heuristic. R8 explicitly normalizes the discovery array and requires exact AppModel package-family ownership while preserving path, signature, WindowDiscovery and WindowObserver proof. `Founder-QA-01` continuity and pre-authority elevation must be fresh at execution. | Founder approval of validated R8 engineering, then one exact transfer and separately one execution |
...
| Production qualification | **Incomplete** | Stage 1, historical Stage 2, Stage 2 R1 and R2 are closed; Stage 3 R1 and failed R2-R7 remain immutable; Stage 3 Qualification R8 engineering is active while transfer and execution remain blocked and unauthorised; Stages 4-7 have not started |
