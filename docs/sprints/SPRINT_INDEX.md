...
separate clean Windows requirement. Sprint 30 remains
qualification-incomplete until Stages 2–7 complete, beginning with separately
authorised Runtime Manifest `1.7.0` package reconciliation.
