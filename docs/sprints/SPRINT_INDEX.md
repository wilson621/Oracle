...
| 30 | Production Qualification | Founder-approved and active; Phases 1–5 locally verified; Sprint 30.5 Stage 1 accepted and closed; historical Stage 2 accepted, closed and immutable but its candidate no longer qualifies current source; Stage 2 Requalification R1 governance-authorised and not begun; Stage 3 historically attempted, incomplete and blocked; Stages 4–7 remain | None | [Decision package](SPRINT_30_FOUNDER_DECISION_REQUIRED.md), [Plan](SPRINT_30_PLAN.md), [Phase 1 implementation](SPRINT_30_PHASE_1_IMPLEMENTATION.md), [Phase 2 implementation](SPRINT_30_PHASE_2_IMPLEMENTATION.md), [Phase 3 implementation](SPRINT_30_PHASE_3_IMPLEMENTATION.md), [Phase 4 implementation](SPRINT_30_PHASE_4_IMPLEMENTATION.md), [Phase 5 implementation](SPRINT_30_PHASE_5_IMPLEMENTATION.md), [Production Qualification dossier](SPRINT_30_PRODUCTION_QUALIFICATION_DOSSIER.md), [Founder acceptance package](SPRINT_30_FOUNDER_ACCEPTANCE_REQUIRED.md), [Stage 1 closure](SPRINT_30_5_STAGE_1_CLOSURE.md), [Stage 1 evidence](evidence/sprint-30-5/stage-1/README.md), [Historical Stage 2 plan](SPRINT_30_5_STAGE_2_PLAN.md), [Historical Stage 2 implementation](SPRINT_30_5_STAGE_2_IMPLEMENTATION.md), [Historical Stage 2 qualification package](SPRINT_30_5_STAGE_2_QUALIFICATION_PACKAGE.md), [Historical Stage 2 closure](SPRINT_30_5_STAGE_2_CLOSURE.md), [Historical Stage 2 evidence](evidence/sprint-30-5/stage-2/README.md), [Stage 2 invalidation decision](SPRINT_30_5_STAGE_2_INVALIDATION_DECISION.md), [Stage 2 Requalification R1 plan](SPRINT_30_5_STAGE_2_REQUALIFICATION_PLAN.md), [Stage 3 plan](SPRINT_30_5_STAGE_3_PLAN.md), [Stage 3 host admission](SPRINT_30_5_STAGE_3_HOST_ADMISSION.md), [Stage 3 admission decision](SPRINT_30_5_STAGE_3_HOST_ADMISSION_DECISION.md), [Stage 3 reconciliation](SPRINT_30_5_STAGE_3_RECONCILIATION.md), [Stage 3 reconciliation evidence](evidence/sprint-30-5/stage-3-reconciliation/README.md), [Qualification Register](../QUALIFICATION_REGISTER.md), [ADR-047](../Decisions.md) |
...
Founder-authorised for governance activation and has not begun; no build,
packaging, signing, certificate creation or qualification execution is
authorised by that activation. Stage 3 was subsequently Founder-authorised
and attempted on the host admitted with a Founder
...
have not started. Stage 2 Requalification R1 creates no Stage 3 authority.
