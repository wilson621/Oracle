...
| 20 | Platform Runtime Activation | Approved Programme; not activated — Founder composition-root ADR decision required | None | [Engineering Programme](../ENGINEERING_PROGRAMME.md), [Founder decision required](SPRINT_20_FOUNDER_DECISION_REQUIRED.md) |
...
runtime persistence remains disabled. Sprint 20 is not activated pending its
required Founder composition-root ADR decision.
