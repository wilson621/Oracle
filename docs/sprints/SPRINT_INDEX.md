...
| 18 | Operator Trust and Control | Active — Phase 3 implemented and rollback-verified; awaiting Founder review | None | [Plan](SPRINT_18_PLAN.md), [Phase 1 audit](SPRINT_18_PHASE_1_AUDIT.md), [Phase 2 evidence](SPRINT_18_PHASE_2_IMPLEMENTATION.md), [Phase 3 evidence](SPRINT_18_PHASE_3_IMPLEMENTATION.md), [ADRs 037–039](../Decisions.md) |
