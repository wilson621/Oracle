...
## Stage 3 R8-baseline qualification impact - 6 August 2026

No new product defect was identified. The dependency is an exact qualification
binding: R12 targets the R6 MSIX, version and signer, while R8 is a different
...
## Stage 4 R8/R13 qualification impact - 6 August 2026

No new Stage 4 product defect was identified. R4 is exact R6/R12 evidence and
cannot transfer to the changed R8 package or R13 chain. R13 does not claim the
ten Stage 4 live journeys.

R4's current controller is not clean-host compatible because it requires a
repository, Git, Node/npm, Supabase CLI and Docker on the execution host. A
